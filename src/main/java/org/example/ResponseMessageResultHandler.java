 ...
 * @since 5.0
 */
public class ResponseMessageResultHandler extends AbstractMessageWriterResultHandler implements HandlerResultHandler {
	 ...
	 */
	public ResponseMessageResultHandler(List<HttpMessageWriter<?>> writers,
